...
Write a function can_build(package, deps) that returns:
...
case1 Solution simple dfs wth state
...
case2 Soltuion Topological sort
...
🔍 How Cycle Detection Works Here (Important)
...
Also note the first solution(case 1) was needed because it was undirected, fgor a directed graph, a simpler visited check would _WorkItem1️⃣ DFS with Recursion Stack (Simplest & Most Common)
Idea
